...
3. **Isolate the problem** &mdash; ideally create an [SSCCE] and a live example.
...
4. Commit your changes in logical chunks. Please adhere to these [git commit message guidelines]
   ...
   Also, prepend name of the feature to the commit message. 
   For instance: "SCSS: Fixes compiler results for IFileListener.\nFixes `#123`"
...
- Before committing, organize usings for each updated C# source file. Either you can
  ...
  like [BatchFormat]
  or like [Power Commands for Visual Studio]
